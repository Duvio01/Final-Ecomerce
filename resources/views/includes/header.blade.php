                        ...
                        <ul class="ah-list ah-list--design1 ah-list--link-color-secondary">
                            <li class="has-dropdown" data-tooltip="tooltip" data-placement="left" title="Account">
                                ...
                                <ul style="width: 120px">
                                    @auth
                                        <li>
                                            <a href="{{route('login')}}"><i class="fas fa-user-circle u-s-m-r-6"></i>
                                ...
                                <div class="mini-cart">
                                            ...
                                            @foreach (session()->get('cart.products') as $cartProduct)
                                                <div class="card-mini-product">
                                                    ...
                                                    <form action=" {{ route('cart.destroy', $cartProduct['product']->id) }}" method="POST">
                                                        ...
                                                        <button class="mini-product__delete-link far fa-trash-alt"></button>
                                                    </form>
                                                </div>
                                            @endforeach
                                    ...
                                    <div class="mini-product-stat">
                                        ...
                                        <div class="mini-action">
                                            <a class="mini-link btn--e-brand-b-2" href="{{route('checkout.index')}}">PROCEED TO
                                                CHECKOUT</a>
